...
- Espresso beverages ranked as the third most profitable category, contributing 11% of total company profit with relatively stable performance throughout the year. Given how closely espresso trails cold brew in total profit distribution, albeit at a much more steady pace, and the temperature range of such products, the category seems like the best candidate to serve as a winter counterpart to cold brew's summer dominance. A targeted seasonal strategy around espresso could help make up for lost cold brew demand during the winter months.
-  Merch and drip coffee products both fall to the bottom in terms of sales volume, revenue and profit. However, merch performance may be more useful to view as a gauge for brand equity. A brand's merchandise is most likely purchased by it's most loyal customers. For Cairn Coffee, the most loyal customers appear to be the one's who purchase coffee beans, particularly those who purchase the bean subscriptions. This reasoning leads me to believe that bundling or cross-promoting merch alongside bean purchases could improve sales in that category, without the need for new customer acquistion. Aside from that suggestion, I believe merch sales will also grow naturally as a result of new customer acqusition, which depends on the strategies employed to stimulate growth for the other products.
